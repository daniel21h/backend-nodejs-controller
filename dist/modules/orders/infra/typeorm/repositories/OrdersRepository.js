...
var OrdersRepository = /** @class */ (function () {
    function OrdersRepository() {
        this.ormRepository = typeorm_1.getRepository(Order_1.default);
    }
    OrdersRepository.prototype.create = function (_a) {
        var user = _a.user, items = _a.items;
        return __awaiter(this, void 0, void 0, function () {
            var order;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        order = this.ormRepository.create({
                            user: user,
                            order_items: items,
                        });
                        return [4 /*yield*/, this.ormRepository.save(order)];
                    case 1:
                        _b.sent();
