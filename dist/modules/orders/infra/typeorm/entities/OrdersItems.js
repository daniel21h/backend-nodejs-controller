...
var _Appointment = _interopRequireDefault(require("../../../../appointments/infra/typeorm/entities/Appointment"));

var _Item = _interopRequireDefault(require("../../../../items/infra/typeorm/entities/Item"));
...
let OrdersItems = (_dec = (0, _typeorm.Entity)('orders_items'), _dec2 = (0, _typeorm.PrimaryGeneratedColumn)('uuid'), _dec3 = Reflect.metadata("design:type", String), _dec4 = (0, _typeorm.ManyToOne)(() => _Appointment.default, order => order.order_items), _dec5 = (0, _typeorm.JoinColumn)({
  name: 'appointment_id'
}), _dec6 = Reflect.metadata("design:type", typeof _Appointment.default === "undefined" ? Object : _Appointment.default), _dec7 = (0, _typeorm.ManyToOne)(() => _Item.default, item => item.order_items), _dec8 = (0, _typeorm.JoinColumn)({
  name: 'item_id'
}), _dec9 = Reflect.metadata("design:type", typeof _Item.default === "undefined" ? Object : _Item.default), _dec10 = (0, _typeorm.Column)(), _dec11 = Reflect.metadata("design:type", String), _dec12 = (0, _typeorm.Column)(), _dec13 = Reflect.metadata("design:type", String), _dec14 = (0, _typeorm.Column)('decimal'), _dec15 = Reflect.metadata("design:type", Number), _dec16 = (0, _typeorm.Column)('int'), _dec17 = Reflect.metadata("design:type", Number), _dec18 = (0, _typeorm.CreateDateColumn)(), _dec19 = Reflect.metadata("design:type", typeof Date === "undefined" ? Object : Date), _dec20 = (0, _typeorm.UpdateDateColumn)(), _dec21 = Reflect.metadata("design:type", typeof Date === "undefined" ? Object : Date), _dec(_class = (_class2 = (_temp = class OrdersItems {
  constructor() {
    ...
    _initializerDefineProperty(this, "item_id", _descriptor4, this);

    _initializerDefineProperty(this, "appointment_id", _descriptor5, this);
  ...
  writable: true,
  initializer: null
}), _descriptor3 = _applyDecoratedDescriptor(_class2.prototype, "item", [_dec7, _dec8, _dec9], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor4 = _applyDecoratedDescriptor(_class2.prototype, "item_id", [_dec10, _dec11], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, "appointment_id", [_dec12, _dec13], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
