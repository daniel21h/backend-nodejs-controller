...
var AppointmentsRepository = /** @class */ (function () {
    ...
    AppointmentsRepository.prototype.findById = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var order;
            return __generator(this, function (_a) {
                order = this.ormRepository.findOne(id, {
    ...
    AppointmentsRepository.prototype.findAllFromProvider = function (_a) {
    ...
    AppointmentsRepository.prototype.create = function (_a) {
        var provider_id = _a.provider_id, user_id = _a.user_id, date = _a.date, delivery_date = _a.delivery_date, items = _a.items;
        return __awaiter(this, void 0, void 0, function () {
            var appointment;
            return __generator(this, function (_b) {
                switch (_b.label) {
