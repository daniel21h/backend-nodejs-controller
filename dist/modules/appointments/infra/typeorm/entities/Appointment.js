...
let Appointment = (_dec = (0, _typeorm.Entity)('appointments'), _dec2 = (0, _typeorm.PrimaryGeneratedColumn)('uuid'), _dec3 = Reflect.metadata("design:type", String), _dec4 = (0, _typeorm.Column)(), _dec5 = Reflect.metadata("design:type", String), _dec6 = (0, _typeorm.ManyToOne)(() => _User.default), _dec7 = (0, _typeorm.JoinColumn)({
  ...
  name: 'provider_id'
}), _dec13 = Reflect.metadata("design:type", typeof _User.default === "undefined" ? Object : _User.default), _dec14 = (0, _typeorm.Column)('timestamp with time zone'), _dec15 = Reflect.metadata("design:type", typeof Date === "undefined" ? Object : Date), _dec16 = (0, _typeorm.Column)('timestamp with time zone'), _dec17 = Reflect.metadata("design:type", typeof Date === "undefined" ? Object : Date), _dec18 = (0, _typeorm.OneToMany)(() => _OrdersItems.default, order_items => order_items.order, {
  cascade: true
}), _dec19 = Reflect.metadata("design:type", Array), _dec20 = (0, _typeorm.CreateDateColumn)(), _dec21 = Reflect.metadata("design:type", typeof Date === "undefined" ? Object : Date), _dec22 = (0, _typeorm.UpdateDateColumn)(), _dec23 = Reflect.metadata("design:type", typeof Date === "undefined" ? Object : Date), _dec(_class = (_class2 = (_temp = class Appointment {
  constructor() {
    ...
    _initializerDefineProperty(this, "delivery_date", _descriptor7, this);

    _initializerDefineProperty(this, "order_items", _descriptor8, this);
  ...
  writable: true,
  initializer: null
}), _descriptor7 = _applyDecoratedDescriptor(_class2.prototype, "delivery_date", [_dec16, _dec17], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor8 = _applyDecoratedDescriptor(_class2.prototype, "order_items", [_dec18, _dec19], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
