...
var AppointmentsController = /** @class */ (function () {
    ...
    AppointmentsController.prototype.create = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var user_id, _a, provider_id, date, delivery_date, items, createAppointment, appointment;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        user_id = request.user.id;
                        _a = request.body, provider_id = _a.provider_id, date = _a.date, delivery_date = _a.delivery_date, items = _a.items;
