...
let SendForgotEmailPasswordService = (_dec = (0, _tsyringe.injectable)(), _dec2 = function (target, key) {
  ...
  async execute({
    ...
    // Verificando existencia do user by email
    ...
    await this.mailProvider.sendMail({
      ...
      subject: '[Lavou] Recuperação de senha',
      templateData: {
...
var _default = SendForgotEmailPasswordService;
