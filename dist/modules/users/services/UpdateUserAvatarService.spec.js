...
var FakeStorageAvatar_1 = __importDefault(require("@shared/container/providers/StorageProvider/fakes/FakeStorageAvatar"));
...
describe('UpdateUserAvatar', function () {
    beforeEach(function () {
        ...
        fakeStorageProvider = new FakeStorageAvatar_1.default();
    ...
    it('should not be able to update avatar from on existing user', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
