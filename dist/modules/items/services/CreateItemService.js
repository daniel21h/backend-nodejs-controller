    ...
    CreateWasherService.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.itemsRepository.findByName(name)];
                    case 1:
                        itemExists = _b.sent();
                        if (itemExists) {
                            throw new AppError_1.default('This item already exist!');
                        }
                        return [4 /*yield*/, this.itemsRepository.create({
                                name: name,
                                category: category,
                                price: price,
                                weight: weight,
